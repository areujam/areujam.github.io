...
Aruzhan Zhamalbek Machine Learning Master’s student at MBZUAI, dedicated to the intersection of AI and Genome/Computational Biology. Building on a Bachelor’s degree in Bioengineering, my current work focuses on developing sophisticated machine learning models to solve complex biological and statistical challenges. I am passionate about applying rigorous programming (C++, Python) and statistical optimization to large-scale datasets.
...
* **Curriculum:** Completed a holistic STEM curriculum spanning Physics, Biology, Chemistry, Mathematics, and Core Engineering principles.
